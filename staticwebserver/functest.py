...
class HttpServer(unittest.TestCase):
    ...
    def test_directory_index(self):
        ...
        self.conn.request("GET", "/tests/dir2/")
        r = self.conn.getresponse()
        data = r.read()
    ...
    def test_index_not_found(self):
        ...
        self.conn.request("GET", "/tests/dir1/")
        r = self.conn.getresponse()
        _ = r.read()
    ...
    def test_file_not_found(self):
        ...
        self.conn.request("GET", "/tests/smdklcdsmvdfjnvdfjvdfvdfvdsfssdmfdsdfsd.html")
        r = self.conn.getresponse()
        _ = r.read()
    ...
    def test_file_in_nested_folders(self):
        ...
        self.conn.request("GET", "/tests/dir1/dir12/dir123/deep.txt")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        self.assertEqual(int(r.status), 200)
    ...
    def test_file_with_slash_after_filename(self):
        ...
        self.conn.request("GET", "/tests/dir2/page.html/")
        r = self.conn.getresponse()
        _ = r.read()
        self.assertEqual(int(r.status), 404)
    ...
    def test_file_with_query_string(self):
        ...
        self.conn.request("GET", "/tests/dir2/page.html?arg1=value&arg2=value")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        self.assertEqual(int(r.status), 200)
    ...
    def test_file_with_spaces(self):
        ...
        self.conn.request("GET", "/tests/space%20in%20name.txt")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        self.assertEqual(int(r.status), 200)
    ...
    def test_file_urlencoded(self):
        """urlencoded filename"""
        self.conn.request("GET", "/tests/dir2/%70%61%67%65%2e%68%74%6d%6c")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        self.assertEqual(int(r.status), 200)
    ...
    def test_large_file(self):
        ...
        self.conn.request("GET", "/tests/wikipedia_russia.html")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        self.assertEqual(int(r.status), 200)
        self.assertEqual(int(length), 954823)
        self.assertEqual(len(data), 954823)
        self.assertIn(b"Wikimedia Foundation, Inc.", data)

    def test_document_root_escaping(self):
        """document root escaping forbidden"""
        self.conn.request("GET", "/tests/../../../../../../../../../../../../../etc/passwd")
        r = self.conn.getresponse()
        _ = r.read()
    ...
    def test_file_with_dot_in_name(self):
        ...
        self.conn.request("GET", "/tests/text..txt")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        self.assertEqual(int(r.status), 200)
    ...
    def test_post_method(self):
        ...
        self.conn.request("POST", "/tests/dir2/page.html")
        r = self.conn.getresponse()
        _ = r.read()
    ...
    def test_head_method(self):
        ...
        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        s.connect((self.host, self.port))
        s.send(b"HEAD /tests/dir2/page.html HTTP/1.0\r\n\r\n")
        data = b""
        while 1:
            buf = s.recv(1024)
            if not buf:
    ...
    def test_file_type_css(self):
        ...
        self.conn.request("GET", "/tests/splash.css")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
    ...
    def test_file_type_js(self):
        """Content-Type for .js"""
        self.conn.request("GET", "/tests/jquery-1.9.1.js")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        ctype = r.getheader("Content-Type")
    ...
    def test_file_type_jpg(self):
        ...
        self.conn.request("GET", "/tests/160313.jpg")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        ctype = r.getheader("Content-Type")
    ...
    def test_file_type_jpeg(self):
        ...
        self.conn.request("GET", "/tests/ef35c.jpeg")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        ctype = r.getheader("Content-Type")
    ...
    def test_file_type_png(self):
        ...
        self.conn.request("GET", "/tests/logo.v2.png")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        ctype = r.getheader("Content-Type")
    ...
    def test_file_type_gif(self):
        ...
        self.conn.request("GET", "/tests/pic_ask.gif")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        ctype = r.getheader("Content-Type")
    ...
    def test_file_type_swf(self):
        ...
        self.conn.request("GET", "/tests/b16261023.swf")
        r = self.conn.getresponse()
        data = r.read()
        length = r.getheader("Content-Length")
        ctype = r.getheader("Content-Type")
