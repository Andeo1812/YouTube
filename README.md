...
Хранилище пользователя: аватар и личные данные - 15 КБ + 15 КБ = 30 [КБ]
...
>
> 21 600 000 * 834 / 2600 = 6 928 615 [штук/месяц] - загруженных видео в месяц с учетом упрощения по CDN
>
...
Таблица действий - число операций в месяц:
...
Табилца - число запросов при загрузке конкретной страницы:
