...
![image](https://user-images.githubusercontent.com/88785411/228651965-02435506-7004-475a-a701-cc0f0e6889aa.png)
...
будем копировать на SSD, чтобы отдавать быстрее, когда популярность будет проходить они будут удаляться с SSD.
