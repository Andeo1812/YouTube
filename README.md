...
* Дневная аудитория - 527 млн.
* Усредненные метрики:

Хранилище пользователя: аватар и личные данные - 2 МБ.
...
> 500 * 60 * 24 * 30 = 21 600 000 - загруженных видео в месяц.
>
> 21 600 000 * 834 / 2600 = 6 928 615 - загруженных видео в месяц с учетом упрощения.
>
> 6 928 615 / 834 000 000 = 0,008 - видео в месяц загружает 1 пользователь.
>
...
Примем сценарий использования сервиса, по которому пользователи выбирают видео для просмотра тремя способами:
...
>
> 764 * 524 = 400 336 млн запросов в сутки.
...
> 17 * 4 = 68 - за 4 видео.
>
> 68 * 524 = 35 621 млн - запросов на бэк в сутки.
...
>
> 428 * 524 = 224 272 млн запросов в сутки.
...
> 18 * 2 = 36 - за 2 видео.
>
> 36 * 524 = 18 864 млн - запросов на бэк в сутки.
...
> 524 * 5.5 = 2882 млн - видео просматривается в сутки.

> 2882 млн * 4% = 115,28 млн - лайков в сутки.
>
> 115,28 млн / (24 * 60 * 60) = 1334 RPS.

> 2882 млн * 0.5% = 14,41 млн - комментариев в сутки.
>
...
>
> 7 229 259 + 1334 + 166 + 6 = 7 230 765 RPS - на Nginx.
